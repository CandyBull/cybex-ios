...
struct ETOMGService {
    enum Config: NetworkHTTPEnv {
        static var productURL = URL(string: "https://etoapi.candybull.io/api")!
        static var devURL = URL(string: "https://etoapi.candybull.io/api")!
        static var uatURL = URL(string: "https://etoapi.candybull.io/api")!
    }
